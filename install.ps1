param([ValidateSet('codex','claude-code','cursor','antigravity')][string]$Target = 'antigravity', [string]$ArchiveUrl = '')
$Prefix = 'PLUGLAYER'
if (!$ArchiveUrl) { $ArchiveUrl = 'https://github.com/pluglayer/antigravity-plugin/archive/refs/heads/main.zip' }
